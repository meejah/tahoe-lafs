...
class DB(unittest.TestCase, ShouldFailMixin):
    ...
    def test_basic(self):
        ...
        yield self.shouldFail(
            NonExistentShareError, "", None,
            self.db.add_or_renew_leases,
    ...
    # XXX this was in the original test, but a) the sqlite version
    # we're using ("or something") and b) this is testing the databse,
    # not leasedb API anyway
